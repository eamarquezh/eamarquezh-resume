(function(){const y=document.createElement("link").relList;if(y&&y.supports&&y.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))M(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const A of i.addedNodes)A.tagName==="LINK"&&A.rel==="modulepreload"&&M(A)}).observe(document,{childList:!0,subtree:!0});function D(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function M(a){if(a.ep)return;a.ep=!0;const i=D(a);fetch(a.href,i)}})();const n=document.getElementById("app");function q(){return document.createElement("br")}function z(){return document.createElement("a")}function p(){return document.createElement("i")}function j(){return document.createElement("h1")}function C(){return document.createElement("div")}function N(){return document.createElement("button")}function O(){return document.createElement("img")}function L(){return document.createElement("p")}function Q(){return document.createElement("footer")}function e(r,y){return r.appendChild(y)}const c=p();c.className="bi bi-translate sobre";const t=N();t.tabIndex="0";t.className="derecha";c.ariaLabel="Eapañol";let m="es";t.textContent=m;t.addEventListener("click",()=>{U(m)});e(t,c);const o=z();o.tabIndex="0";o.href="#Eric";o.className="skip-link";o.textContent="Skip to main content";o.ariaLabel="you can to go by main content or you can change the language hwen pressing tab";const u=O();u.src="https://avatars.githubusercontent.com/u/10810956?v=4";u.tabIndex="0";u.alt="Profile photo";u.className="logo vanilla";const s=j();s.id="Eric";s.tabIndex="0";s.ariaLabel="Hi I'm Eric Marquez this is a simply resume but if you use the option accesibility I hope you have the best user experience";s.textContent="Hi I'm Eric Marquez";const d=p();d.tabIndex="0";d.ariaLabel="go to my linkedin profile";d.className="bi bi-linkedin sobre";d.addEventListener("keydown",r=>{r.key==="Enter"&&window.open("https://www.linkedin.com/in/eamarquezh/","_blank")});d.addEventListener("click",()=>{window.open("https://www.linkedin.com/in/eamarquezh/","_blank")});const b=p();b.tabIndex="0";b.ariaLabel="go to my github profile";b.className="bi bi-github sobre";b.addEventListener("keydown",r=>{r.key==="Enter"&&window.open("https://github.com/eamarquezh/","_blank")});b.addEventListener("click",()=>{window.open("https://github.com/eamarquezh/","_blank")});const l=N();l.tabIndex="0";l.textContent="Download this resume";const E=p();E.className="bi bi-arrow-down-square-fill sobre";let P="./CV-Eric-Marquez(en).pdf";l.addEventListener("click",()=>{window.open(P,"_blank")});e(l,E);const x=C();x.className="contenedor";const w=C();w.className="item";const v=C();v.className="item";const S=C();S.className="item";const h=p();h.tabIndex="0";h.ariaLabel="here is my carrer path";h.className="bi bi-person-vcard-fill tam";const g=p();g.tabIndex="0";g.ariaLabel="here is my educational History";g.className="bi bi-mortarboard-fill tam";const f=p();f.tabIndex="0";f.ariaLabel="here is my skills";f.className="bi bi-lightning-charge-fill tam";const k=L();k.innerHTML=`<h2 tabindex='0'>Career path</h2>
    ...
    de versiones,...</p>`;const I=L();I.innerHTML=`<h2 tabindex='0'>Skills</h4>
    ...
    <i tabindex='0' aria-label='documents' class="bi bi-file-earmark-word-fill" style='color:#2980b9;'></i>
        ...
        python), Como dirigir el servicio de atención a clientes,
        programador con Java para aplicaciones Android, control
        de versiones,...</p>`,I.innerHTML=`<h2 tabindex='0'>Skills</h4>
        <p tabindex='0'><i class="bi bi-bug"></i>QA Software.</p>
        <p tabindex='0'><i class="bi bi-database"></i>Data Science.</p>
        <p tabindex='0'><i class="bi bi-code-slash"></i>Software Developer.</p>
        <p>
        ...
        <i tabindex='0' aria-label='presentation' class="bi bi-file-earmark-ppt-fill" style='color:#d35400;'></i>
        <i tabindex='0' aria-label='documents' class="bi bi-file-earmark-word-fill" style='color:#2980b9;'></i>
        </p>`}async function F(){c.ariaLabel="English",o.textContent="Ir a contenido principal",o.ariaLabel="for english press Enter o tabulador para elegir el idioma entre español o ingles",u.alt="Foto de perfil",s.ariaLabel="Hola soy Eric Marquez esta es una simple hoja de vida pero puedes elegir las opciones de accesibilidad, espero tengas la mejor experiencia de usuario",s.textContent="Hola soy Eric Marquez",d.ariaLabel="ir a mi perfil de linkedin",b.ariaLabel="ir a mi perfil de github",l.textContent="Descargar hoja de vida",P="./CV-Eric-Marquez(es).pdf",e(l,E),h.ariaLabel="mi camino laboral",g.ariaLabel="mis estudios",f.ariaLabel="estas son mis habilidades",k.innerHTML=`<h2 tabindex='0'>Camino laboral</h2>
        ...
        python), Como dirigir el servicio de atención a clientes,
        programador con Java para aplicaciones Android, control
        de versiones,...</p>`,I.innerHTML=`<h2 tabindex='0'>Habilidades</h4>
        <p tabindex='0'><i class="bi bi-bug"></i>QA Software.</p>
        <p tabindex='0'><i class="bi bi-database"></i>Data Science.</p>
        <p tabindex='0'><i class="bi bi-code-slash"></i>Software Developer.</p>
        <p>
